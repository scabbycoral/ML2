...
########################################/
grid = np.zeros((N_f1, N_f2), dtype=int)
grid_1_2 = grid.copy()
for i in range(len(X_phonemes_2)):
    grid_1_2[int(X_phonemes_2[i][0]) - min_f1 - 1][int(X_phonemes_2[i][1]) - min_f2 - 1] = 2
for i in range(len(X_phonemes_1)):
    grid_1_2[int(X_phonemes_1[i][0]) - min_f1 - 1][int(X_phonemes_1[i][1]) - min_f2 - 1] = 1

g = np.zeros((N_f2, N_f1), dtype=int)
M = g.copy()
for i in range(len(X_phonemes_2)):
    M[int(X_phonemes_2[i][1]) - min_f2 - 1][int(X_phonemes_2[i][0]) - min_f1 - 1] = 2
for i in range(len(X_phonemes_1)):
    M[int(X_phonemes_1[i][1]) - min_f2 - 1][int(X_phonemes_1[i][0]) - min_f1 - 1] = 1
